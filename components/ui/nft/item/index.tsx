...
const NftItem: FunctionComponent<NftItemProps> = ({item, buyNft}) => {
  ...
  // Function to determine file type based on metadata
    ...
    <>
      <div className="flex-shrink-0">
        <div className="h-full w-full flex items-center justify-center bg-gray-200">
          {/* Display file type instead of the image */}
          <p className="text-lg font-medium text-indigo-600">{getFileTypeLabel(item.meta.image)}</p>
        </div>
      </div>
